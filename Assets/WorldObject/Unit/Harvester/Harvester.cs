...
public class Harvester : Unit {
    ...
    public float emptyHarvestVolume = 1.0f, harvestVolume = 1.0f, startHarvestVolume = 1.0f;
            ...
            if (harvesting || emptying) {
                ...
                if (harvesting) {
                    ...
                    if (currentLoad >= capacity) {
                        // Make sure that we have a whole number to avoud bugs
    ...
    public override void MouseClick(GameObject hitObject, Vector3 hitPoint, Player controller) {
        ...
        if (player && player.human) {
            if (!WorkManager.ObjectIsGround(hitObject)) {
                ...
                if (resource && !resource.isEmpty()) {
                    // Make sure that the selected harvester remains selected
    ...
    protected override void InitialiseAudio() {
        ...
        } else if (emptyHarvestVolume > 1.0f) {
        ...
        } else if (startHarvestVolume > 1.0f) {
