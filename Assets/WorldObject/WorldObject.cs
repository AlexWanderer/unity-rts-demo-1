...
public class WorldObject : MonoBehaviour {
    ...
    // We want to restruct how many decisions are made to help with game performance
    ...
    /**
     * A child class shold only determine other conditions under which a decision should
     * not be made. This could be harvesting for a harvester, for example. Alternatevely,
    ...
    public virtual void SaveDetails(JsonWriter writer) {
        ...
        if (attacking) {
            // Only save if attacking so that we not end up storing massive numbers for no reason
            ...
            if (worldObject) {
                ...
                if (owner) {
                    ...
                    if (player && player.human) {
                        ...
                        // Start attack of object is not owned by the same player and this object can attack, else select
    ...
    public virtual void SetHoverState(GameObject hoverObject) {
        // Only handle input of owned by a human player and currently selected
        if (player && player.human && currentlySelected) {
            ...
            if (!WorkManager.ObjectIsGround(hoverObject)) {
                ...
                if (owner) {
                    // The object is owened by a player
    ...
    protected virtual void UseWeapon() {
        ...
        // This behaviour needs to be specified by a specfic object
    }
